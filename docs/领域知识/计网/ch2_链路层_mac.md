...
![](images/ch2/hidden_terminal_problem.png)

暴露终端问题如下图，B向A发送数据和C向D发送数据是不冲突的，但是B和C会由于检测到对方正在发送，而误以为发生了冲突

![](images/ch2/expose_terminal_problem.png)
...
<center><img src="images/ch2/token_ring.png" width=300></center>
...
<center><img src="images/ch2/binary_coundown.png" width=200></center>
...
![](images/ch2/tree_walk-through.png)
